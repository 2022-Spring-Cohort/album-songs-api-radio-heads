...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Album album1 = new Album("Purgatory", "./frontend-spa/AlbumCovers/tyler_childers_-_purgatory.png", "Tyler Childers");
        ...
        Album album2 = new Album("A Fever You Can't Sweat Out", "img", "P!ATD");
        ...
        Album album3 = new Album("A Beautiful Lie", "img", "Thirty Seconds To Mars");
        ...
        Album album4 = new Album("Artificial Selection", "img", "Dance Gavin Dance");
        ...
        Album album5 = new Album("Audioslave", "img", "Audioslave");
        ...
        Album album6 = new Album("Good Kid Mad city", "img", "Kendrick Lamar");
        ...
        Album album7 = new Album("In The Aeroplane Over The Sea", "img", "Neutral Milk Hotel");
        ...
        Album album8 = new Album("Long.Live.ASAP", "img", "A$AP Rocky");
        ...
        Album album9 = new Album("Life Of Pablo", "img", "Ye");
        ...
        Album album10 = new Album("This Place Will Become Your Tomb", "img", "Sleep Token");
